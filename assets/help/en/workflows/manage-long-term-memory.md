...
- How do I see what Qube remembered about me?
- Can I delete a memory entry?
- How do I turn off automatic memory capture?

## What it is

Long-term **Memory** stores distilled facts separate from Library documents. This workflow covers reviewing entries in Memory Manager, editing or deleting mistakes, and tuning automation in Memory settings.

## Where to find it

Open **Memory Manager** from the main navigation. Automation toggles live in **Settings → Memory**.

## Also called

review memories, edit saved memory, clear memory, memory manager workflow, forget what Qube learned
