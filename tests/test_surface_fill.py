...
def test_preset_catalog_includes_documented_ids():
    for preset_id in (
        ...
        "builtin.catppuccin-latte-gradient",
        "builtin.qube-signature",
        "builtin.indigo-trail",
        "builtin.prism-drift",
        "builtin.conversation-glow",
        "builtin.library-shimmer",
        "builtin.studio-hues",
        "builtin.morning-glow",
        "builtin.daybreak-tide",
        "builtin.midnight-ember",
        "builtin.cyber-mint",
        "builtin.obsidian-rose",
        "builtin.northern-fire",
        "builtin.emerald-dusk",
        "builtin.velvet-wine",
        "builtin.solar-flare",
        "builtin.peach-sorbet",
        "builtin.sea-glass",
        "builtin.lilac-haze",
    ):
