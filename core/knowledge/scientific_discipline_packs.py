...
SCIENTIFIC_DISCIPLINE_ENGINEERING = "engineering"
...
SCIENTIFIC_DISCIPLINE_PACKS: tuple[ScientificDisciplinePack, ...] = (
    ScientificDisciplinePack(
        ...
        fallback_adapters=("nice", "cdc", "who", "clinicaltrials_gov", "openfda", "openalex", "pubmed", "europe_pmc"),
    ...
    ScientificDisciplinePack(
        ...
        fallback_adapters=("uniprot", "pdb", "openalex", "europe_pmc"),
        entity_pack_hints=("biomedical",),
        status="active",
        notes="6c-1 + 7b + Slice 16: molecular life science; UniProt + PDB fallbacks.",
    ),
    ScientificDisciplinePack(
        ...
        fallback_adapters=("chembl", "chemrxiv", "uspto_patentsview", "epo_espacenet", "openalex", "pubmed"),
        status="active",
        notes="6c-2 + Slice 16/18: PubChem primary; ChEMBL, ChemRxiv, and patent fallbacks.",
    ),
    ScientificDisciplinePack(
        ...
        fallback_adapters=("openalex", "nasa_ads"),
        status="active",
        notes="6c-5 + 7a: arXiv + INSPIRE-HEP; NASA ADS live with API token.",
    ),
    ScientificDisciplinePack(
        ...
        fallback_adapters=("openreview", "acl_anthology", "openalex", "acm_dl"),
        status="active",
        notes="6b + Slice 15: DBLP primary; OpenReview + ACL Anthology for CS/NLP venues.",
    ),
    ScientificDisciplinePack(
        ...
        fallback_adapters=("world_bank", "eurostat", "oecd", "bls", "openalex", "ssrn"),
        status="active",
        notes="6c-4: RePEc live via EconBiz API; SSRN via OpenAlex index.",
    ),
    ScientificDisciplinePack(
        ...
        ui_group="Psychology",
        primary_adapters=("pubmed",),
        fallback_adapters=("openalex", "psyarxiv", "psycinfo"),
        status="active",
        notes="6c-3: PubMed primary; PsyArXiv preprints; PsycINFO via EBSCO EDS.",
    ),
    ScientificDisciplinePack(
        ...
        status="active",
        notes="6c-3 + 7b: OpenAlex primary; SocArXiv live via OSF API.",
    ),
    ScientificDisciplinePack(
        ...
        status="active",
        notes="6c-3: OpenAlex primary; SSRN working papers via OpenAlex index.",
    ),
    ScientificDisciplinePack(
        id=SCIENTIFIC_DISCIPLINE_EARTH_ENVIRONMENT,
        label="Earth & Environment",
        ui_group="Earth & Environment",
        primary_adapters=("openalex",),
        fallback_adapters=("ipcc", "copernicus_cds", "usgs", "noaa", "nasa_earthdata", "arxiv"),
        status="active",
        notes="Climate, geoscience, remote sensing; NOAA token + NASA CMR metadata.",
    ),
    ScientificDisciplinePack(
        id=SCIENTIFIC_DISCIPLINE_ENGINEERING,
        label="Engineering",
        ui_group="Engineering",
        primary_adapters=("ieee_xplore", "nist", "ietf_rfc"),
        fallback_adapters=("uspto_patentsview", "epo_espacenet", "arxiv", "openalex"),
        status="active",
        notes="P0 + Slice 18: IEEE/NIST/IETF primary; USPTO PatentsView + EPO OPS patent fallbacks.",
    ),
    ScientificDisciplinePack(
