...
CAPABILITY_SPECS: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec(
        "pro.custom_model_paths",
        "Custom STT / TTS / embedding models",
        EditionTier.PRO,
        "Advanced model path configuration beyond bootstrap defaults.",
    ),
    CapabilitySpec(
        "pro.wakeword_library",
        "Alternate wakeword library",
        EditionTier.PRO,
        "In-app catalog and Test Lab for wake phrases beyond the default.",
    ),
    CapabilitySpec(
        "pro.mcp_filesystem",
        "MCP Filesystem integration",
        EditionTier.PRO,
        "Connect local folders through the MCP Filesystem server.",
    ),
    CapabilitySpec(
        "pro.memory_timeline",
...
FEATURE_CAPABILITY_REGISTRY: dict[str, str] = {
    ...
    "models.advanced_model_paths": "pro.custom_model_paths",
    "voice.wakeword_library": "pro.wakeword_library",
    "integrations.mcp_filesystem": "pro.mcp_filesystem",
